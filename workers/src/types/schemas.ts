...
export const UserPublicSchema = z.object({
  ...
  avatar_url: Str({ required: false, example: 'https://example.com/avatar.jpg' }),
...
export const RegisterRequestSchema = z.object({
  email: Str({ example: 'user@example.com' }),
  username: Str({ example: 'johndoe' }),
  password: Str({ example: 'SecurePass123', description: 'At least 8 characters with uppercase, lowercase, and number' }),
  verification_code: Str({ example: '123456', description: '6-digit verification code' }),
...
export const CreateCommentRequestSchema = z.object({
  ...
  content: Str({ example: 'Great article!', description: 'Comment content (max 2000 characters)' }),
...
export const CreatePostRequestSchema = z.object({
  content: Str({ example: 'Hello world!', description: 'Post content (max 2000 characters)' }),
